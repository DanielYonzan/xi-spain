...
<div class="language-select">
    <div class="language-box">SELECT LANGUAGE <a href="{{route('changeLanguage','sp')}}" class="es @if($lang=='sp') active @endif">ES</a> <a href="{{route('changeLanguage','en')}}" class="en @if($lang=='en') active @endif">EN</a></div>
</div>
    ...
    <div class="container"><!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="{{route('admin.dashboard')}}" class="btn-login"><i class="fa fa-sign-in"></i> Login</a> </li>
                </li>
                <!--/language-->
            </ul>
        </div>
...
<!-- Header -->
@php($hometitle = ['en'=>['intro1'=>'IMPORT EXPORT AGENCY BUSINESS','intro2'=>'Focused in Food & Beverages'],'sp'=>['intro1'=>'','intro2'=>'Wine & Food Agents<br>Líder del sector alimentación y bebidas']])
<header>
    <div class="container">
...
<script type="text/javascript">
    (function () {
        var options = {
            whatsapp: "+0044 7594529345", // WhatsApp number
