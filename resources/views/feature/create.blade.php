...
@section('content')
    <div class="page">
        <form class="validate" action="{{route('feature.store')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="short_description_en" rows="5" maxlength="300" required></textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="short_description_sp" rows="5" maxlength="300" required></textarea>
            ...
            <input type="submit" value="Create Feature" class="btn btn-primary">
        </form>
    </div>
@endsection
