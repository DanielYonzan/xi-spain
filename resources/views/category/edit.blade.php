...
@section('content')
    <div class="page">
        <form class="validate" action="{{route('category.update',$data->id)}}" method="post" enctype="multipart/form-data">
            {{ method_field('PUT') }}
            {{csrf_field()}}
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="input-container">
                            ...
                            <img class="img-fluid imgTarget imgTarget1" src={{asset('img/category/'.$data->image)}} width="800" alt="{{$data->name}}">
