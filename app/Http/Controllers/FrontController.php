...
class FrontController extends Controller
{
    ...
    function getCatalogue()
    {
        ...
        if (!$data) {
            ...
            $productIds = ProductCategory::where('category',$category)->pluck('product');
            ...
            $html .= '<thead><tr><th width="3%">S.N.</th><th width="20%">Name</th><th width="10%">Image</th><th width="10%">Size</th><th width="10"%>Exw&nbsp;Price(€)</th><th width="10%">Origin</th><th width="8%">Min Order</th><th>Short Description</th></tr></thead>';
